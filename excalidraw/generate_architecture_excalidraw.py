    ...
    nodes = [
        {
            ...
            "x": 40,
            "y": 40,
            "text": "GitHub Actions (Orchestration Layer)",
            "color": "#e67700",
            "bg": "#fff3bf",
            "dashed": True,
        ...
        },
        {
            ...
            "color": "#1864ab",
            "bg": "#d0ebff",
            "logo": "https://icdn.24h.com.vn/images/2023/logo-24h-new.svg",
            "phase": "Source",
        },
        {
            "id": "b2",
        ...
        },
        {
            ...
            "color": "#5f3dc4",
            "bg": "#e5dbff",
            "logo": "https://raw.githubusercontent.com/dlt-hub/dlt/devel/docs/website/static/img/dlt-logo.svg",
            "phase": "Extract",
        },
        {
            "id": "b5",
        ...
        elements.append(
            {
                ...
                "height": box_h,
                "strokeColor": color,
                "backgroundColor": "transparent" if is_container else bg,
                "fillStyle": "solid",
        ...
        elements.append(
            {
                ...
                "link": None,
                "text": text,
                "fontSize": 24 if is_container else 18,
                "fontFamily": 1,
                "textAlign": "left",
                "verticalAlign": "middle",
                "baseline": 22,
